...
const organization = require('../shared/better-auth.sngN0Nfi.cjs');
...
const admin = require('../shared/better-auth.103n83nN.cjs');
...
const plugins_oidcProvider_index = require('../shared/better-auth.DrsZJNuB.cjs');
